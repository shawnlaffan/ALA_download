...
Originally adapted from code written by Nick Dosremedios and Hugh Burley.
...
library (stringr)
library (rgdal) 
# library (CoordinateCleaner)  #  needs additional system level libs
```
...
subset_colnames <- c("id", "x", "y", "scientificName", "family", "genus", "species", "rank", "coordinateUncertaintyInMetres")
