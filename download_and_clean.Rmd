...
Later additions have cribbed from https://atlasoflivingaustralia.github.io/ALA4R/articles/ALA4R.html
...
#  An email address is needed to download data from the ALA
email_address <- "peterpan@neverneverland.org"
email_address <- "shawnlaffan@gmail.com"
...
```{r}
#  grid it up and plot richness patterns
